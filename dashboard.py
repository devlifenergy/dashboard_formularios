...
def carregar_itens_master():
    ...
    todos_os_itens = [
        ...
        ('ESGG05','ESG - Pilar social', 'Controles', 'Riscos relevantes são identificados e acompanhados regularmente.', 'NÃO'),
        ('ESGG06','ESG - Pilar social', 'Controles', 'Controles internos funcionam e são revisados quando necessário.', 'NÃO'),
